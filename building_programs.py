...
class Vehicle:
    ...
    @property                                   # Property method for converting speed to kmh
    def speed_kmh(self):
    ...
    @staticmethod                               # Static method within class which acts as a helper
    def is_fast(mph):
        if mph > 150:
            return True
        else:
    ...
    @speed.setter                               # Setter method which is a controlled way to set speed
