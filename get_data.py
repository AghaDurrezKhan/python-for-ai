...
url = f"https://api.open-meteo.com/v1/forecast?latitude=25.3753&longitude=68.3651&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Hyderabad Weather - Past Week')
plt.legend()
